...
publish: true
tags: ["기계학습"]
description: "서포트 벡터 머신의 분류 경계와 마진 개념을 살펴보고 마진을 최대화하는 선형 분류 원리를 정리한 노트입니다."
---
...
# **KKT 조건 2. Primal feasibility (원래 제약 만족)**
...
# **KKT 조건 4. Complementary Slackness (여기가 핵심)**
$$
