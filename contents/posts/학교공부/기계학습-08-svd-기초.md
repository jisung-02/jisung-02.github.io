...
## 한 줄 요약
$X=U\Sigma V^T$. $U$는 데이터를 가장 잘 설명하는 직교 방향(주성분), $\Sigma$는 각 방향의 중요도, $V^T$는 새 좌표 — [L07 부분공간 기저 투영](/posts/기계학습-07-부분공간-기저-투영/)에서 필요했던 직교정규기저 $U$를 SVD가 만들어 준다.
...
관련: [L07 부분공간 기저 투영](/posts/기계학습-07-부분공간-기저-투영/) · [L09 특이값분해 SVD 2](/posts/기계학습-09-svd-응용/) · [중간 종합정리](/posts/기계학습-중간-종합정리/)
